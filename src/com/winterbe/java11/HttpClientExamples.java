...
//
///*
//The following only works in Java 11
//e.g. Now you can replace "String" with "var". The compiler infers the correct type from the assignment of the variable.
//    uncomment the following to be run in Java 11
// */
